					...
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
								...
								<td><a href="javascript:sureToApprove(<?php echo $row['pet_id'];?>)" class="ico del">Approve</a></td>
								<td><a href="appoint.php?id=<?php echo $row['pet_id'];?>" class="ico del">Appointment</a></td>
							</tr> 
                          <?php  
                               }  
                          }  
